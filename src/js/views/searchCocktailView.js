...
// Get Input function
export const getInput = () => elements.searchCocktailInput.value;

// Clear the input the user provided
export const clearInput = () => elements.searchCocktailInput.value = '';
...
const limitCocktailTitle = (title, limit = 17) => {
...
const renderCocktail = cocktail => {
    ...
    <div class="result-box col span-1-of-4">
        ...
        <div class="cocktail-feature">
            <i class="ion-ios-beer icon-small"></i>
            <p>Alcoholic: ${cocktail.strAlcoholic}</p>
        </div>
        <div class="cocktail-feature">
            <i class="ion-ios-book icon-small"></i>
...
export const renderCocktailResults = cocktails => {
    ...
    if (!cocktails) {
        ...
        // Add Error Class
        elements.messageOne.classList.add('red');

        // Add Text
        elements.messageOne.innerHTML = `There are no Cocktails named '${elements.searchCocktailInput.value}'. Please try again.`;
    } else {
